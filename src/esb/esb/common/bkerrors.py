...
bk_error_codes_conf = {
    ...
    "COMPONENT_COMP_CONF_ERROR": {
        ...
        "solution": (
            ...
            "and the JSON string needs to be a dict or a list that can be converted to a dict"
        ),
    },
    ...
    "REQUEST_SSL_ERROR": {
        ...
        "solution": (
            "Check if the folder in the component configuration corresponding to SSL_ROOT_DIR exists, "
            "and if the certificates are valid"
        ),
    },
    "REQUEST_GSE_ERROR": {
        "code": "1306204",
    ...
    "REQUEST_SMTP_ERROR": {
        ...
        "solution": (
            "Check if the sending email component SMTP configuration is correct, "
            "and if the SMTP email service is normal"
        ),
    },
